...
const AppliedJobs = (props) => {
  ...
  let fetchData = async () => {
    const response = await axios.get(
      `${import.meta.env.VITE__APP_API}/job/user-jobs`,
      {
        headers: {
          Authorization: `Bearer ${userData.jwtToken}`,
        },
    ...
    if (response.data.allJobs) {
      setUserList(response.data.allJobs);
    }
  };
  useEffect(() => {
    fetchData();
  ...
  return (
    <React.Fragment>
      ...
      <div className="page-content">
        <Container fluid>
          {/* Render Breadcrumbs */}
          <Breadcrumbs title="jobs" breadcrumbItem="Applied Job " />
